...
function banner() {
  ...
  console.log('')
  console.log('  FROM A PHONE this cannot work over plain http: the Push API needs a')
  console.log('  secure context and http://<lan-ip> is not one. It would need an HTTPS')
  console.log('  certificate the phone trusts — and this fixture has world-known')
  console.log('  passwords, so it must not be exposed off-host to obtain one.')
  console.log('')
