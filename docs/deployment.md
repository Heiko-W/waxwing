...
point `resourceUrl` at `…/download/waxwing-stalwart-v0.23.0.zip` and it stays there.
...
`expected SourceRepositoryRef to be refs/tags/v0.23.0, got refs/heads/main`.
...
```jsonc
"resourceUrl": "https://github.com/Heiko-W/waxwing/releases/download/v0.23.0/waxwing-stalwart-v0.23.0.zip"
...
```sh
mkdir -p /srv/waxwing && tar -xzf waxwing-web-v0.23.0.tar.gz -C /srv/waxwing
```
