...
| **G2** | **Gate: owner reviews M3 (D3 decided 2026-07-21)** | — | M3.10, G2-followups, G2-review | todo | D3 deferred (no v1.0 exists); **D6 open**: reverse ADR-010 and build Web Push? **B19 open**: does the phishing interstitial's copy overclaim? |
